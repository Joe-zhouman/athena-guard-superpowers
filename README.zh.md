...
| **gemini** | 双子 | 善变、不安分、想法碰撞和突变 → **点子生成器 / brainstorm 对练搭档**：抛出你没考虑过的角度，说到一半能转弯，防止设计对话过早定稿 | 同样——还没有需要这个的用例 |
...
**如果你是成本敏感型用户，三思。** 这不是轻量插件。如果你的上下文窗口经常塞满，或者 token 预算吃紧，这可能不适合你。上游 superpowers 更精简。

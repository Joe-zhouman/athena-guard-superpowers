...
- **brainstorming uses the spec-writer format** (Problem / Design Rationale / Implementation Notes / Acceptance)
- **All findings persist** to `docs/superpowers/` (findings-local.md, findings-external.md, progress.md, reviews/) so large projects survive across sessions. virgo and sagittarius write separate files so they can be dispatched in parallel without conflicts.

See `docs/athena/` for the full picture.
